...
import 'package:fitandheal/App/src/Widgets/RoundItem/Round1_item.dart';
import 'package:fitandheal/App/src/Widgets/RoundItem/Round2_item.dart';
        ...
        child: Column(
          children: <Widget>[
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    Container(
                        margin: EdgeInsets.only(top: 60, left: 175),
                        child: BackButton()),
                  ],
                ),
              ],
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => StartEx2()));
              },
              child: Row(
                children: <Widget>[
                  Stack(
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => StartEx3()));
              },
              child: Row(
                children: <Widget>[
                  Stack(
