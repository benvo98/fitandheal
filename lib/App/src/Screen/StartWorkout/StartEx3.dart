...
class StartEx3 extends StatefulWidget {
  @override
  _StartEx3State createState() => _StartEx3State();
}

class _StartEx3State extends State<StartEx3> with TickerProviderStateMixin {
