...
class Break3 extends StatefulWidget {
  @override
  _Break3State createState() => _Break3State();
}

class _Break3State extends State<Break3> with TickerProviderStateMixin {
  ...
  method() {
    Future.delayed(Duration(seconds: 10), () {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => StartEx4()));
    });
  }
